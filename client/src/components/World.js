...
class World extends Component {
    ...
    componentWillReceiveProps = (nextProps) => {
        ...
        let api;
        if (!guardian) {
            api = 'http://localhost:4000/world?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all';
            //api = 'http://ec2-52-90-225-69.compute-1.amazonaws.com:4000/world?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all';
        } else {
            api = 'http://localhost:4000/world.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq';
            //api = 'http://ec2-52-90-225-69.compute-1.amazonaws.com:4000/world.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq';
        }
        fetch(api)
            .then(res => res.json())
