...
class Business extends Component {
    ...
    componentWillReceiveProps = (nextProps) => {
        ...
        let api;
        if(!guardian){
            //api = 'http://ec2-54-174-22-8.compute-1.amazonaws.com:4000/business';
            api = "http://localhost:4000/business";
        }else{
            //api = 'http://ec2-54-174-22-8.compute-1.amazonaws.com:4000/business.json';
            api = 'http://localhost:4000/business.json';
