//https://api.nytimes.com/svc/topstories/v2/technology.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq
//http://localhost:5000/technology.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq
...
router.get('/', async (req, res) => {
    ...
    const api_url = 'https://api.nytimes.com/svc/topstories/v2/technology.json?api-key=' + apiKey;
    ...
    for (let i = 0; i < len; ++i) {
        ...
        //determine if there is any null element
        if(title == null || url == null || date == null || description == null || section == null){
            continue;
        }
