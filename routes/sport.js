//http://localhost:5000/sport?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
//https://content.guardianapis.com/sport?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
...
//     const api_url = 'https://content.guardianapis.com/sport?api-key=' + apiKey + '&show-blocks=all'
...
//http://localhost:3000/sport?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
//https://content.guardianapis.com/sport?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
const express = require('express');
const router = express.Router();
const fetch = require('node-fetch');
