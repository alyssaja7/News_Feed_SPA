//https://api.nytimes.com/svc/topstories/v2/politics.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq
//http://localhost:5000/politics.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq
...
router.get('/', async (req, res) => {
    ...
    const api_url = 'https://api.nytimes.com/svc/topstories/v2/politics.json?api-key=' + apiKey;
