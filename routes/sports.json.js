//https://api.nytimes.com/svc/topstories/v2/sports.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq
//http://localhost:5000/sports.json?api-key=ci5mI5D1XhSbHZfaueFFTKqMDclZfABq
...
router.get('/', async (req, res) => {
    ...
    const api_url = 'https://api.nytimes.com/svc/topstories/v2/sports.json?api-key=' + apiKey;
