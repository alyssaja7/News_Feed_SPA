// //http://localhost:4000/world?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
// //https://content.guardianapis.com/world?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
...
//     const api_url = 'https://content.guardianapis.com/world?api-key=' + apiKey + '&show-blocks=all'
...
//http://localhost:4000/world?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
//http://ec2-54-234-227-5.compute-1.amazonaws.com:4000/world?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
//https://content.guardianapis.com/world?api-key=c05384c5-6def-48bd-8d98-ad6b7c9e9caa&show-blocks=all
const express = require('express');
const router = express.Router();
const fetch = require('node-fetch');
